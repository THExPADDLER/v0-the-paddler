...
export const products: Product[] = [
  ...
  },
  {
    ...
    name: "SKULL ART TEE",
    description: "OVERSIZED FIT",
    longDescription: "The SKULL ART TEE blends street culture with artistic expression. The detailed skull graphic represents the duality of life - raw yet refined, dark yet meaningful. A bestseller that defines the PADDLER aesthetic.",
    price: 1399,
    mrp: 1999,
  ...
  },
  {
    ...
    description: "OVERSIZED FIT",
    longDescription: "The KANJI SPIRIT TEE draws inspiration from Japanese street culture. The kanji characters embody the spirit of movement and identity that PADDLER represents. A fusion of Eastern philosophy and Western streetwear.",
    price: 1299,
    mrp: 1999,
